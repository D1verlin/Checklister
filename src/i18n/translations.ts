...
export const translations = {
  ru: {
    ...
    playerMpv: 'MPV (Рекомендуется)',
    playerMpvDesc: 'Двусторонний трекинг прогресса, автопереход по сериям, интеграция Discord RPC и OSD-сообщения.',
    ...
    playerCustom: 'Другой кастомный плеер',
    playerCustomDesc: 'Прямой запуск бинарного файла (например: vlc.exe, mpc-hc64.exe).',
    customPlayerPlaceholder: 'C:\\Program Files\\MPC-HC\\mpc-hc64.exe',
    mpvPathLabel: 'Путь к исполняемому файлу mpv.exe',
    mpvPathPlaceholder: 'C:\\mpv\\mpv.exe',
    btnDetectMpv: 'Найти автоматически',
    btnDetectingMpv: 'Поиск...',
    btnBrowseMpv: 'Обзор...',
    mpvStatusReady: 'Готов к работе',
    mpvStatusNotFound: 'MPV не найден по указанному пути',
    mpvStatusChecking: 'Проверка...',
    mpvDownloadHint: 'У вас не установлен MPV? Скачайте сборку с официального сайта:',
    mpvFoundToast: 'MPV успешно обнаружен',
    mpvNotFoundToast: 'MPV не обнаружен автоматически. Укажите путь вручную через «Обзор».',
    settingAutoNext: 'Автопереход к следующей серии (Binge-watching)',
    settingAutoNextDesc: 'Автоматически добавлять оставшиеся серии сезона в очередь mpv и переключаться на них без закрытия окна.',
    settingThreshold: 'Порог отметки о просмотре серии',
    settingThresholdDesc: 'Серия помечается как просмотренная при достижении указанного процента хронометража.',
  ...
  en: {
    ...
    playerMpv: 'MPV (Recommended)',
    playerMpvDesc: 'Bi-directional progress tracking, playlist binge-watching, live Discord RPC sync, and OSD notifications.',
    ...
    playerCustom: 'Other Custom Executable',
    playerCustomDesc: 'Direct binary execution (e.g. mpc-hc64.exe, vlc.exe).',
    customPlayerPlaceholder: 'C:\\Program Files\\MPC-HC\\mpc-hc64.exe',
    mpvPathLabel: 'Path to mpv.exe binary',
    mpvPathPlaceholder: 'C:\\mpv\\mpv.exe',
    btnDetectMpv: 'Auto Detect',
    btnDetectingMpv: 'Searching...',
    btnBrowseMpv: 'Browse...',
    mpvStatusReady: 'Ready for playback',
    mpvStatusNotFound: 'MPV not found at this path',
    mpvStatusChecking: 'Validating...',
    mpvDownloadHint: "Don't have MPV installed? Download a build from the official site:",
    mpvFoundToast: 'MPV executable detected successfully',
    mpvNotFoundToast: 'Could not auto-detect MPV. Please select the file manually using "Browse...".',
    settingAutoNext: 'Auto-next episode (Binge-watching)',
    settingAutoNextDesc: 'Queue subsequent season episodes into MPV and transition seamlessly without closing the player.',
    settingThreshold: 'Watched completion threshold',
    settingThresholdDesc: 'Episode is marked as watched once this percentage of total duration is reached.',
